...
namespace dz13.Account
{
    ...
    public class Invoice
    {
        ...
        public void RemoveFromBalance(decimal sum, Clients.Client client)
        {
            this.account -= sum;
            AccountChanged?.Invoke(new Case(client, false, sum));
        }
        ...
        public void AddToBalance(decimal sum, Clients.Client client)
        {
            this.account += sum;
            AccountChanged?.Invoke(new Case(client, true, sum));
        }
